...
(function() {
        if (typeof jsfFaceletsDebug === 'undefined') {
            var jsfFaceletsDebug = false;
        }
        if (!jsfFaceletsDebug) {
            var faceletsOrigKeyup = document.onkeyup;
            document.onkeyup = function(e) {
                if (window.event) e = window.event;
                if (String.fromCharCode(e.keyCode) == 'X' & e.shiftKey & e.ctrlKey) faceletsDebug('/mojarra-bug-ui-debug-0.0.1-SNAPSHOT/index.xhtml?facelets.ui.DebugOutput=1679180375766');
                jsfFaceletsDebug = true;
